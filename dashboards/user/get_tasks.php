    ...
    <div class="container-fluid mt--9">   
      ...
      <div class="row">
        <div class="col-xl-12 mb-5 mb-xl-0">
          ...
          <h1 class="text-center">Получить задание</h1>
            <!-- Display errors -->
            <?php 
            if(!empty($errors)) { ?>
    ...
    <div class="text-center col-12 px-5 my-2">
      <?php 
        ...
        if($participaiting){
          ...
          $tasks = R::find( 'tasks',
          ' id NOT IN ('.R::genSlots( $participaiting_tasks ).') AND completed = false',
                              ...
                              <td>
                                  <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                                      <div class="row mx-auto justify-content-end">
                                          ...
                                          <button type="submit" name="participate" class="btn btn-sm btn-success">Участвовать</button>
                                      </div>
                                  </form>
                              </td>
                          </tr>
